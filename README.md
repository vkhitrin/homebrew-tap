...
| [orobardet/gitlab-ci-linter](https://gitlab.com/orobardeta/gitlab-ci-linter) | [gitlab-ci-linter.rb](./Formula/gitlab-ci-linter.rb)     | Tool for validating .gitlab-ci.yml using Gitlab API.     |
